...
pub use rpc::{
    ...
    AddProfileParams, AppSettingsPatch, CodexSettingsPatch, DoctorUpdatedPayload,
    ...
    LogsTailParams, LogsTailResult, ProfileIdParams, ProfilesUpdatedPayload, QueryStateItem,
