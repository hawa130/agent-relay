  ...
  "result": {
    ...
    "initial_state": {
      "status": {
        ...
        "profile_count": $launches,
        "active_state": {
          "active_profile_id": "p_active_$launches",
      ...
      "profiles": [
        {
          "profile": {
            "id": "p_active_$launches",
            "nickname": "active-$launches",
            "agent": "Codex",
            "priority": 100,
            "enabled": true,
            ...
            emit_json <<EOF
{
  ...
  "error": {
    "code": -32602,
    "message": "missing field `mode`",
    "data": {
      "relay_error_code": "RELAY_INVALID_INPUT"
    }
  }
}
EOF
